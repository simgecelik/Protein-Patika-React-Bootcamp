...
function Text() {
  return (
    <div className="textpage">
      <svg  style={{ marginLeft: '25px',marginTop:"20px"}}
        width="341"
        height="144"
        viewBox="0 0 341 144"
        fill="none"
      ...
      <h1 style={{ marginLeft: '25px'}}>YAZILIM PATİKALARI</h1>
      <p style={{ marginLeft: '25px'}}>
        Bootcamp'ler teknoloji kariyerine girmek isteyenler için yeni bir<br></br>
        eğitim modelidir. Ekibini büyütmek isteyen şirketler bir<br></br>
        bootcamp'lere sponsor olurlar. Teknik beceriler kazanmaya<br></br>
        başlamış ancak işe girmeye hazır olmayan kişiler bootcamp'lere<br></br>
        başvururlar. Seçilen adaylar 4-8 haftalık ücretsiz ve yoğun<br></br>
        eğitime kabul alırlar. Bootcamp'lerde başarılı olan öğrenciler<br></br>
